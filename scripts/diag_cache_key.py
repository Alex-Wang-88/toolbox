...
MODEL_DIR = os.path.join(ROOT, "tts_poc", "models", "CosyVoice3-0.5B")
CACHE_DIR = os.path.join(ROOT, "app_data", "tts_cache")
REF_AUDIO = os.path.join(ROOT, "app_data", "voices", "crystal_cosyvoice3", "speaker.wav")
